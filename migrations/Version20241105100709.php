 ...
 */
final class Version20241105100709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity DROP user_id, DROP description');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD user_id INT DEFAULT NULL, ADD description LONGTEXT NOT NULL');
